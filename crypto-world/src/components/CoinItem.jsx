        ...
        <tr className='h-[80px] border-b overflow-hidden'>
            ...
            <td>
                <div className='flex items-center'>
                    <img className='w-7 mr-2 rounded-full' src={coin.image} alt={coin.id} />
            ...
            <td>
                {coin.price_change_percentage_24h > 0 ? (<p className='text-green-600'>{coin.price_change_percentage_24h.toFixed(2)}%</p>)
